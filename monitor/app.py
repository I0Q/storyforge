...
.rowBtns{display:flex; gap:12px; align-items:flex-end; justify-content:flex-end; flex-wrap:wrap;}
            ...
            parts.append('<div class="btnrow"><a class="btn tiny" href="/voices?t=' + h(token) + '"><span class="ico">🗣️</span><span class="txt">Voices</span></a></div>')
            parts.append('</div>')
            ...
            if running is None:
                ...
                btns = []
                btns.append('<a class="btn tiny" href="/job/' + jid + '?t=' + h(token) + '"><span class="ico">👁️</span><span class="txt">OPEN</span></a>')
            ...
            for meta in metas:
                ...
                if meta.get('mp3') and st == 'completed':
                    ...
                    btns.append('<a class=\"btn tiny\" href=\"/dl/' + jid + '?t=' + h(token) + '\" target=\"_blank\" rel=\"noopener\"><span class="ico">⬇</span><span class="txt">Download</span></a>')
...
(function(){
  function stopAll(exceptId){
    ...
    document.querySelectorAll('[data-play]').forEach(function(b){ b.innerHTML='<span class=\"ico\">▶︎</span><span class=\"txt\">PLAY</span>'; });
  }
  ...
  document.addEventListener('click', function(ev){
    ...
    t.innerHTML='<span class=\"ico\">⏸</span><span class=\"txt\">HIDE</span>';
