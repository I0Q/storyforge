...
def api_production_sfml_generate(payload: dict[str, Any] = Body(default={})):  # noqa: B008
    ...
    try:
        ...
        instructions = (
            ...
            'C) Create scenes (scene-1, scene-2, ...) only when there are significant setting/time/beat shifts. Don\'t create too many short scenes.\n'
            'D) Output SFML with correct formatting.\n\n'
